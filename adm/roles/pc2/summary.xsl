...
<header id="header">
	<div class="container">
		<div class="row">
			<div class="span4">	<a class="visible-desktop" style="margin-top:15px" id="logo" href="http://acmacpc.org">
	   			<div class="site-logo"></div>	
				</a>
				<a class="hidden-desktop" style="margin-top:15px" id="logo" href="http://acmacpc.org">
				<img  width="225" height="92" src="images/logo.png" alt="ACM ACPC" />
				</a>
				</div>	
            ...
            <TABLE border="0">
		<tr>	
			<td><center>Tunisian ACM</center></td>
		</tr>
	    </TABLE>	
...
<p>
<b>Installed and configured by ACMACPC</b><br/>Scoreboard is developed by  <A HREF="http://www.ecs.csus.edu/pc2"> CSUS PC^2 <xsl:value-of select="/contestStandings/standingsHeader/@systemVersion"/></A><br/>
